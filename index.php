...
<head>
    <meta charset="UTF-8">
    <title>Consentua Binary UI - MobileID</title>
...
<body>
    ...
    $(document).on('consentua-ready', function()
    {
        ...
        window.consentua.addString('will-use', {'en': 'What data we use;'});
        window.consentua.addString('for-purpose', {'en': 'How we use your data;'});
